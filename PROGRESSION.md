...
**Unassigned brick pool** (in the catalog, no slot yet): **Anchor** ＋, **Tremor** −,
**Bomb** −−, **Maw** hazard. Natural-feeling homes to consider — Anchor early (slot 3 or 7;
it's positive, and the old plan liked a second helper early), Tremor for Monsoon Sector

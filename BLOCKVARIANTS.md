...
| **Feather** | 0.25 | very light — shoved around by later landings | warm cream **plume pillow** — overlapping cosine-scalloped feather shingles with soft crescent shadows, extra-round corners, whisper-fine barb strands and tiny down-flecks drifting upward; perpetually **floats + sways**; soft landing **flutter**, no slam. Light because it's downy — the deliberate opposite of Ice's cold gloss | ✅ | `FeatherBlockData`, `FeatherBlockSkin`, `Feather.shader` |

/// <summary>
/// The active-piece control / Dynamic-wreckage settle thresholds documented by PHYSICS.md.
/// They are identical in every game mode and live here as code-owned constants, one canonical source that cannot
...
/// ComboDetector) are unchanged. Tuning the profile means editing one value here - and it applies
...
public static class PhysicsProfile
{
    ...
    /// <summary>How long a freely dynamic piece must stay settled before sleeping.</summary>

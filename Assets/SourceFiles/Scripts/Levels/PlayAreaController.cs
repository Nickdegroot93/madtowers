...
public class PlayAreaController : MonoBehaviour
{
    ...
    // Resources folder holding the theme's ground.png (generated by
    // Tools/generate_ground_sprite.py). Its flat plateau is scaled to the floor width and
    // aligned to the floor top; the floor bar's own renderer is hidden. The collider is
    // untouched. Deliberately NOT serialized (same stale-import-cache hazard as
    // BlockController.SkinResourcesFolder); theme code sets this at runtime.
    public static string GroundSkinResourcesFolder = "Skins/Classic";
    ...
    {
        if (string.IsNullOrEmpty(GroundSkinResourcesFolder)) return;

        Sprite ground = Resources.Load<Sprite>($"{GroundSkinResourcesFolder}/ground");

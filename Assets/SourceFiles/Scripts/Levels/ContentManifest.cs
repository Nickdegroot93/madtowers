...
public class ContentManifest : ScriptableObject
{
    ...
    [SerializeField] private BlockData normalVariant; // the plain brick (excluded from `variants`) - the Vault needs it
    ...
    public BlockData NormalVariant => normalVariant;
    ...
    public void EditorPopulate(AbilityDefinition[] discoveredAbilities, BlockDefinition[] discoveredBlocks,
        BlockData[] discoveredVariants, BlockData discoveredNormal, AbilityRarityProfile profile)
    {
        ...
        normalVariant = discoveredNormal;

...
/// <summary>
/// The Dizzy look: a swirling pink-marble vortex set into each cell (procedural Resources/Dizzy shader),
...
/// </summary>
public sealed class DizzyBlockSkin : BlockVariantSkin
{
    ...
    protected override string MaterialResource => "Dizzy";
    protected override bool HidesChapterArt => false; // the vortex sits over the chapter colour
    protected override string CellName => "DizzyCell";

    private float _age;
    private float _swirl;

    /// <summary>Build the vortex look. Called from DizzyBlockData.OnApplied.</summary>

...
/// plus a small camera punch. The life-lost SOUND and the heart animation are driven separately
...
public sealed class LifeLossFx : MonoBehaviour
{
    ...
    private static readonly Color MistColor = new Color(0.85f, 0.88f, 0.92f, 0.55f);
    ...
    public static void Play(Vector3 blockPosition)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            puff.transform.localScale = new Vector3(size, size * 0.7f, 1f);
            ...
            fx._baseAlphas.Add(MistColor.a * Random.Range(0.7f, 1f));
        }

...
- `Scripts/Core`: Global game state (`GamePhase`, pause owners, spawn availability), run state/results, block ledger accounting, difficulty control, events, and small reusable runtime helpers.
